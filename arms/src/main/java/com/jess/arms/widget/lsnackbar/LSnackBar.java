...
public class LSnackBar {
    ...
    final void showView() {
        if (mView.getParent() == null) {
            ...
            if (lp instanceof CoordinatorLayout.LayoutParams) {
                ...
                LogUtils.debugInfo("syb",""+marginTop);
    ...
    private Animation getAnimationInFromTopToDown() {
        return AnimationUtils.loadAnimation(mView.getContext(), R.anim.fade_in);
    }
    ...
    private Animation getAnimationOutFromTopToDown() {
        return AnimationUtils.loadAnimation(mView.getContext(), R.anim.fade_out);
    }
