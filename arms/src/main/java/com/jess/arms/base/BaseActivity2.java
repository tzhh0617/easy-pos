...
/**
 * 移除butterknife -> viewbinding
 * ================================================
 */
public abstract class BaseActivity2<T extends ViewBinding, P extends IPresenter> extends AppCompatActivity implements IActivity, ActivityLifecycleable {
    ...
    protected void jumpActivity(Context context,Class className) {
