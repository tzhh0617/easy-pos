...
public class ArmsUtils {
    ...
    public static void snackbarTextWithLong(String text,int width,int height) {
        AppManager.getAppManager().showSnackbar(text, true,width,height);
    }
