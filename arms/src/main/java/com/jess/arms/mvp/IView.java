...
public interface IView {
    ...
    default void getCommonF(String msg) {
        showMessage(msg);
    }

    default void showCommonFDialog(String msg) {
    }
    ...
    default void onChangeS(String msg,boolean isBack) {
